...
} from "./chunk-XYDBC6RC.js";
import "./chunk-6VCYUQJG.js";
import {
  Button_default,
  useButtonProps
} from "./chunk-MSSSFML6.js";
import {
  _extends
...
import "./chunk-ZKHAF7VL.js";
import {
  CardHeaderContext_default
} from "./chunk-64QSKEOB.js";
import {
  useBootstrapPrefix
...
function map(children, func) {
  let index = 0;
  return React10.Children.map(children, (child) => React10.isValidElement(child) ? func(child, index++) : child);
}
function forEach(children, func) {
  let index = 0;
  React10.Children.forEach(children, (child) => {
    if (React10.isValidElement(child)) func(child, index++);
  });
}
