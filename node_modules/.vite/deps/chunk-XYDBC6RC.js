...
import {
  useBootstrapPrefix
} from "./chunk-WOKGMJTR.js";
import {
  require_jsx_runtime
} from "./chunk-LMYBRFWF.js";
import {
  require_classnames
} from "./chunk-Z3WFHBEF.js";
import {
  __commonJS,
  __toESM,
  require_react
...
function useTabPanel(_ref) {
  ...
  const context = (0, import_react7.useContext)(TabContext_default);
  ...
  const {
    ...
    getControlledId,
    getControllerId
  } = context, rest = _objectWithoutPropertiesLoose2(context, _excluded2);
...
var TabPanel = React3.forwardRef(
  ...
  (_ref2, ref) => {
    let {
      as: Component = "div"
    } = _ref2, props = _objectWithoutPropertiesLoose2(_ref2, _excluded3);
    const [tabPanelProps, {
      isActive,
      onEnter,
      onEntering,
    ...
    return (0, import_jsx_runtime.jsx)(TabContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime.jsx)(SelectableContext_default.Provider, {
        value: null,
        children: (0, import_jsx_runtime.jsx)(Transition2, {
          in: isActive,
          onEnter,
          onEntering,
          onEntered,
...
var Tabs = (props) => {
  ...
  const generateChildId = (0, import_react8.useMemo)(() => generateCustomChildId || ((key, type) => id ? `${id}-${type}-${key}` : null), [id, generateCustomChildId]);
  const tabContext = (0, import_react8.useMemo)(() => ({
    onSelect,
    activeKey,
    transition,
...
function useMergedRefs2(refA, refB) {
  return (0, import_react11.useMemo)(() => mergeRefs2(refA, refB), [refA, refB]);
}
...
var TabContent = React10.forwardRef(({
  className,
  bsPrefix,
  as: Component = "div",
  ...props
...
var TabPane = React11.forwardRef(({
  bsPrefix,
  transition,
  ...props
}, ref) => {
  ...
  return (0, import_jsx_runtime6.jsx)(TabContext_default.Provider, {
    value: null,
    children: (0, import_jsx_runtime6.jsx)(SelectableContext_default.Provider, {
      value: null,
      children: (0, import_jsx_runtime6.jsx)(Transition2, {
        in: isActive,
        onEnter,
        onEntering,
        onEntered,
        ...
        children: (0, import_jsx_runtime6.jsx)(Component, {
          ...rest,
          ref,
          className: (0, import_classnames3.default)(className, prefix, isActive && "active")
        })
      })
    })
  });
...
object-assign/index.js:
  ...
  *)
*/
//# sourceMappingURL=chunk-XYDBC6RC.js.map
